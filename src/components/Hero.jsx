        ...
        <div className="order-1 lg:order-2 lg:col-span-5 flex flex-col justify-center text-center lg:text-left">
          <div className="space-y-6 lg:space-y-8">
            ...
            <p className="text-base sm:text-lg text-zinc-600 max-w-md mx-auto lg:mx-0">
              Archetype Digital builds technical structures for the modern web. We blend architectural discipline with digital innovation.
            </p>
            
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6">
              <button className="w-full sm:w-auto bg-[#7D2237] text-white px-8 py-4 font-semibold rounded-lg border border-[#7D2237] hover:bg-transparent hover:text-[#7D2237] transition-all duration-300">
                View Portfolio
              </button>
